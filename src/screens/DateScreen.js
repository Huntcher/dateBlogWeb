...
const DateScreen = ({ navigation }) => {
  ...
  let inputProps={
    ...
    mensajes:[
      ...
      {id: '256',user: 'VickyLu',receiver: 'Todos',msg: 'Buenas noches a todos los que durmieron acompañaditos esta noche jejeje <3 Los quiero!!!!',date: '24 Abr',hour: '0.931944444444445',pic:'https://huntcherapp.s3.us-east-2.amazonaws.com/dateblog/images/People/MujeresMin/pexels-marcelo-chagas-2005011.jpg',picReceiver:'https://huntcherapp.s3.us-east-2.amazonaws.com/dateblog/images/Pics/SexyMin/all1.jpg', type: 1},
